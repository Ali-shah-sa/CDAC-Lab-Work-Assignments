    ...
    internal class Program
    {
        ...
        static void Main4()
        {
           ...
           // var emps = from emp in lstEmp where emp.Basic>10000 select emp;
            ...
            var emps = from emp in lstEmp where emp.Basic > 10000 && emp.Basic < 120000 select emp;
        ...
        {
            AddRecs();
            //var emps = from emp in lstEmp where emp.Basic > 10000
            //   orderby emp.Name  select emp;
            ...
            var emps =from emp in lstEmp orderby emp.EmpNo ascending,  emp.Name ascending select emp;
        ...
        static void Main6()
        {
            ...
            foreach(var item in emps)
            {
                ...
                Console.WriteLine(item.dept.DeptNo);
            }
